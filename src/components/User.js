        ...
        <div className='user'>
            ...
            <div className='user__infos'>
                <p className='user__info'>
                    01 rue Laurent lavoisier 59370 Mons-en-baroeul</p>
                <p className='user__info'>
                    <a href="tel:+33760286493">0760286493</a>
                </p>
                <p className='user__info'>
                    <a href="mailto:mouhamed.92.dia@gmail.com">mouhamed.92.dia@gmail.com</a>
                </p>
                <p className='user__info'>Date de Naissance: 16 Août 1995</p>
